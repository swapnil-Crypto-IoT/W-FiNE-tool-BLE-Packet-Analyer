...
# runs the multiple file which will download the different company logos from 
...
process_list = ["Image_url_opening\(Downloading\)_4.py","Image_url_opening\(Downloading\)_8.py"]
# for i in range(0,8):
#     print("Image_url_opening\(Downloading\)_{}.py".format(i+1))
#     process_list.append("Image_url_opening\(Downloading\)_{}.py".format(i+1))
